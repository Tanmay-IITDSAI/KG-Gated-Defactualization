...
Required environment variables (in .env):
    GROQ_API_KEY=gsk_...
    LOCAL_MODEL_NAME=meta-llama/Llama-2-13b-chat-hf   # optional — falls back to Groq
    STEER_LAYER=28
    STEER_ALPHA=12.0
    HF_TOKEN=hf_...   # required — Llama-2-13b-chat-hf is a gated model
"""
...
LOCAL_MODEL_NAME = os.getenv("LOCAL_MODEL_NAME", "meta-llama/Llama-2-13b-chat-hf")
STEER_LAYER      = int(os.getenv("STEER_LAYER", "28"))    # 13b has 40 layers; layer 28 ≈ 70% depth
STEER_ALPHA      = float(os.getenv("STEER_ALPHA", "12.0")) # 13b hidden=5120; slightly lower than 7b's 15.0
...
def _run_kg_activation_steering(defactualized_prompt: str, style: str, kg: SupportKG) -> str:
    ...
    # Llama-2-chat-hf expects: <s>[INST] <<SYS>>\n{system}\n<</SYS>>\n\n{user} [/INST] {assistant_prefix}
    system_instruction = (
