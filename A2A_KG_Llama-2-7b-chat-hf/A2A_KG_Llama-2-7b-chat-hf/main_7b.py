...
Required environment variables (in .env):
    GROQ_API_KEY=gsk_...
    LOCAL_MODEL_NAME=meta-llama/Llama-2-7b-chat-hf   # optional — falls back to Groq
    STEER_LAYER=20
    STEER_ALPHA=15.0
    HF_TOKEN=hf_...   # required — Llama-2-7b-chat-hf is a gated model
"""
...
LOCAL_MODEL_NAME = os.getenv("LOCAL_MODEL_NAME", "meta-llama/Llama-2-7b-chat-hf")
STEER_LAYER      = int(os.getenv("STEER_LAYER", "20"))    # 7b has 32 layers; layer 20 ≈ 63% depth
STEER_ALPHA      = float(os.getenv("STEER_ALPHA", "15.0")) # 7b hidden=4096
